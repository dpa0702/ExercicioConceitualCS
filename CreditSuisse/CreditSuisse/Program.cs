...
using CreditSuisse.DomainTrade;

namespace CreditSuisse
{
    //12/11/2022
    //4
    //2000000 Private 12/29/2025 false
    //400000 Public 07/01/2020 true
    //5000000 Public 01/02/2024 false
    //3000000 Public 10/26/2023 true
    class Program
    {
        ...
        static void output(List<Trade> trades)
        {
            ...
            if (trades.Count > 0)
            {
                foreach (var item in trades)
                {
                    ...
                    Console.WriteLine("{0}, {1}, {2}, {3}, {4}", item.Value, item.ClientSector, item.NextPaymentDate.ToString("MM/dd/yyyy"), item.category, item.IsPoliticallyExposed);
                }
            }
            else
            {
